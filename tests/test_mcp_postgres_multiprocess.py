    ...
    environment.update(
        {
            ...
            # The independent response-loss partner needs time to hold its
            # acknowledgement. Main's in-process upstream stress executor does
            # not consult these values, so keep its contention probes quick.
